...
namespace YoutubeApi.Application.Behaviours
{
        ...
        where TRequest : IRequest<TResponse>
    {
        ...
        public Task<TResponse> Handle(TRequest request, RequestHandlerDelegate<TResponse> next, CancellationToken cancellationToken)
        {
            ...
            if (failtures.Any())
                throw new ValidationException(failtures); //hata durumunda exception fırlatır.

            return next(); //hata yoksa response'a yönlendirir.
        }
    }
}
